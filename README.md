...
2. Copy and unzip AWSSQSMonitor-\<version\>.zip from 'target' directory into \<machine_agent_dir\>/monitors/
3. Edit config.yml file in AWSSQSMonitor and provide the required configuration (see Configuration section)
